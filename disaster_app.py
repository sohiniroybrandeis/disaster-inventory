...
from retrieval import answer_question, extract_relevant_years, texts  # import your functions
...
# User Input
question = st.text_input("Enter your question:", value="What disasters occurred in 2023 in East Africa?")
submit = st.button("Get Answer")

if submit and question.strip():
    with st.spinner("Retrieving relevant context and generating an answer..."):
        # Reroute key parts of your logic here
        ...
        # Optional: toggle context preview
